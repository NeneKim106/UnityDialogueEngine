...
namespace CHARACTERS {
    ...
    public class CharacterConfigData {
        public string name;
        public string alias;
        public Character.CharacterType charaterType;
        ...
        public CharacterConfigData Copy() {
            ...
            result.name = name;
            result.alias = alias;
            result.charaterType = charaterType;
        ...
        private static Color defaultColor => DialogueSystem.instance.config.defualtTextColor;
        ...
        public static CharacterConfigData Default {
            get {
                ...
                result.name = "";
                result.alias = "";
                result.charaterType = Character.CharacterType.Text;
